...
public class LevelsScreen{
	...
	public StackPane getLayout(){
		...
		buttons.add(new MenuButton(() -> loadLevel(1), 100, 120, 75, 75, new Image(getClass().getClassLoader().getResourceAsStream("button_level_1.png"))));
		buttons.add(new MenuButton(() -> loadLevel(2), 200, 120, 75, 75, new Image(getClass().getClassLoader().getResourceAsStream("button_level_2.png"))));
		buttons.add(new MenuButton(() -> loadLevel(3), 300, 120, 75, 75, new Image(getClass().getClassLoader().getResourceAsStream("button_level_3.png"))));
		buttons.add(new MenuButton(() -> loadLevel(4), 400, 120, 75, 75, new Image(getClass().getClassLoader().getResourceAsStream("button_level_4.png"))));
